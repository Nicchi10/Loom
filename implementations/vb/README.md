...
## 1. Quickstart - implementing a Tool (with a small stroke of genius)
...
## 2. `Loom.Core` - the contract layer
...
## 3. `Loom.Engine` - the orchestrator
...
## 5. The data flow in one paragraph
